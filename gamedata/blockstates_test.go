...
func TestBlockStatesForEverySupportedVersion(t *testing.T) {
	...
	stateCounts := map[types.ProtocolId]int32{
		...
		types.ProtocolVersions.MINECRAFT_1_14_2.ID:  11271,
		types.ProtocolVersions.MINECRAFT_1_14_3.ID:  11271,
		types.ProtocolVersions.MINECRAFT_1_14_4.ID:  11271,
		types.ProtocolVersions.MINECRAFT_1_15.ID:    11337,
