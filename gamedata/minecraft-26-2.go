...
// will not have them any other way. See minecraft-26-2-content.go.
func registriesMinecraft26_2() []Registry {
	registries := []Registry{
	...
	return append(registries, generatedRegistriesMinecraft26_2()...)
}
