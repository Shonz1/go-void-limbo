...
//
// The 26.1 counterpart of generatedRegistriesMinecraft26_2, produced by the same
// process from the older client's own data, and not derived from the 26.2 file
// next door. Deriving would not work: the two versions differ by more than the
// entries 26.2 adds. 26.2 rewrote the entity predicates inside eleven
// enchantments, moving "type" to "minecraft:entity_type" and "location" to
// "minecraft:location", and an entry in the new shape is one 26.1 cannot read.
//
// What 26.2 adds and this therefore leaves out: the sulfur_cube_archetype
// registry entirely, the sulfur_cube_hot damage type, and the bounce jukebox
// song. The last of those is why this file exists -- bounce names a sound event
// 26.1 has no entry for, and a jukebox song naming a sound that is not there
// fails to parse and takes the registry with it.
//
// The same two rewrites as the 26.2 file are applied on the way in, for the same
// reasons: tag references become empty sets, and spawn_conditions is dropped
// from the mob variants.
func generatedRegistriesMinecraft26_1() []Registry {
	return []Registry{
							...
							"requirements": nbt.Compound{
								...
								"terms": nbt.List{ElementType: nbt.TagCompound, Elements: []nbt.Tag{
									...
									nbt.Compound{
										...
										"entity":    nbt.String("this"),
										"predicate": nbt.Compound{
											"type": nbt.String("minecraft:trident"),
										},
									},
									nbt.Compound{
					...
					"minecraft:equipment_drops": nbt.List{ElementType: nbt.TagCompound, Elements: []nbt.Tag{
						nbt.Compound{
							...
							"requirements": nbt.Compound{
								...
								"predicate": nbt.Compound{
									"type": nbt.String("minecraft:player"),
								},
							},
						},
					}},
													...
													nbt.Compound{
														...
														"terms": nbt.List{ElementType: nbt.TagCompound, Elements: []nbt.Tag{
															nbt.Compound{
																...
																"entity":    nbt.String("this"),
																"predicate": nbt.Compound{
																	"movement_affected_by": nbt.Compound{
																		"block": nbt.Compound{
																			"blocks": nbt.List{},
																		},
																	},
