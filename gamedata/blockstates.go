...
// byte-identical to 1.14.3's, so 490 numbers them as 498 does.
...
// 1.16.1, 1.16, 1.15.2, 1.15.1, 1.15, 1.14.4 and 1.14.3 answer to as well. 1.17 is also where the cauldron split by what it holds, and the
...
// on 1.15.1, on 1.15, on 1.14.4 and on 1.14.3, and one stored with none does
// not.
