...
// none either, so 485 does as well.
...
// 1.16.1, 1.16, 1.15.2, 1.15.1, 1.15, 1.14.4, 1.14.3 and 1.14.2 answer to as well. 1.17 is also where the cauldron split by what it holds, and the
...
// on 1.15.1, on 1.15, on 1.14.4, on 1.14.3 and on 1.14.2, and one stored with
// none does not.
