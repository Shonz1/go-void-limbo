...
import (
	...
	"github.com/Shonz1/go-void-limbo/packets/serverbound/common"
...
// A client from before the configuration phase -- 1.16.4, 1.17, 1.17.1, 1.18, 1.18.2, 1.19, 1.19.1, 1.19.3, 1.19.4 or 1.20 -- is in
