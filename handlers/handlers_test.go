...
func TestHandleLoginStartServerboundPacketEntersPlayOnAVersionWithNoConfigurationPhase(t *testing.T) {
	for _, version := range []types.ProtocolVersion{types.ProtocolVersions.MINECRAFT_1_16_2, types.ProtocolVersions.MINECRAFT_1_16_3, types.ProtocolVersions.MINECRAFT_1_16_4, types.ProtocolVersions.MINECRAFT_1_17, types.ProtocolVersions.MINECRAFT_1_17_1, types.ProtocolVersions.MINECRAFT_1_18, types.ProtocolVersions.MINECRAFT_1_18_2, types.ProtocolVersions.MINECRAFT_1_19, types.ProtocolVersions.MINECRAFT_1_19_1, types.ProtocolVersions.MINECRAFT_1_19_3, types.ProtocolVersions.MINECRAFT_1_19_4, types.ProtocolVersions.MINECRAFT_1_20} {
