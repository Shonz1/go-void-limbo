...
var (
	...
	protocol1_14    = types.ProtocolVersions.MINECRAFT_1_14.ID
	protocol1_14_1  = types.ProtocolVersions.MINECRAFT_1_14_1.ID
	protocol1_14_2  = types.ProtocolVersions.MINECRAFT_1_14_2.ID
	protocol1_14_3  = types.ProtocolVersions.MINECRAFT_1_14_3.ID
	protocol1_14_4  = types.ProtocolVersions.MINECRAFT_1_14_4.ID
	protocol1_15    = types.ProtocolVersions.MINECRAFT_1_15.ID
	protocol1_15_1  = types.ProtocolVersions.MINECRAFT_1_15_1.ID
	...
	protocol1_16_3  = types.ProtocolVersions.MINECRAFT_1_16_3.ID
	protocol1_16_4  = types.ProtocolVersions.MINECRAFT_1_16_4.ID
	protocol1_17    = types.ProtocolVersions.MINECRAFT_1_17.ID
	protocol1_17_1  = types.ProtocolVersions.MINECRAFT_1_17_1.ID
	...
	protocol26_3    = types.ProtocolVersions.MINECRAFT_26_3.ID
)
...
//
// 26.3 numbers every packet it reads as 26.2 does but one: 26.3 retired the
// swing, which sat at 0x3F, for the punch at 0x2E, and the punch is what the
// swing's row below names for 26.3 -- the one packet in these tables that
// goes by another name on the latest version, and the 26.2 step rewrites
// the swing into it. 26.1 and 26.2 number all of these the same, and the 1.21.x versions from
...
// the two jars' protocol registrations agree on. 1.17.1 numbers everything
// it reads as 1.18 does, 1.18 having added no serverbound packet, and 1.17
// as 1.17.1 does, in both directions. 1.16.4 sits one higher than 1.17
// through the play phase from the keep alive to the player input, with the
// same three absences: it still has the container acknowledgement at 0x07,
// in front of everything this server reads but the teleport
// acknowledgement, which 1.17 retired for the pong at 0x1D, behind the
// player input and in front of the swing, so the swing is numbered alike.
// The login and status phases are numbered alike. 1.16.3 numbers every
// phase as 1.16.4 does, in both directions, and 1.16.2 as 1.16.3 does: the
// three jars register the same packets in the same order. 1.16.1 numbers
// every packet this server reads as they do but the swing, one lower at
...
// on: it has no jigsaw generate, which 1.16 put at 0x0F. 1.15.1 numbers
// every phase as 1.15.2 does, its connection protocol registering the same
// packets in the same order, and 1.15 as 1.15.1 does, the two jars'
// connection protocol being one class byte for byte. 1.14.4 numbers every
// phase as 1.15 does: 1.15 added no serverbound packet and retired none.
// 1.14.3 numbers every phase as 1.14.4 does, its connection protocol
// registering the same serverbound packets in the same order, and 1.14.2
// as 1.14.3 does, for the same reason, and 1.14.1 as 1.14.2 does, the two
// jars' connection protocol being one class byte for byte, and 1.14 as
// 1.14.1 does, its connection protocol registering the same packets in the
// same order. The ids
...
var serverboundPackets = []serverboundPacket{
	...
	},
	{
		...
		ids:     packetIds{protocolZero: 0x01, protocol1_14: 0x01, protocol1_14_1: 0x01, protocol1_14_2: 0x01, protocol1_14_3: 0x01, protocol1_14_4: 0x01, protocol1_15: 0x01, protocol1_15_1: 0x01, protocol1_15_2: 0x01, protocol1_16: 0x01, protocol1_16_1: 0x01, protocol1_16_2: 0x01, protocol1_16_3: 0x01, protocol1_16_4: 0x01, protocol1_17: 0x01, protocol1_17_1: 0x01, protocol1_18: 0x01, protocol1_18_2: 0x01, protocol1_19: 0x01, protocol1_19_1: 0x01, protocol1_19_3: 0x01, protocol1_19_4: 0x01, protocol1_20: 0x01, protocol1_20_2: 0x01, protocol1_20_3: 0x01, protocol1_20_5: 0x01, protocol1_21: 0x01, protocol1_21_2: 0x01, protocol1_21_4: 0x01, protocol1_21_5: 0x01, protocol1_21_6: 0x01, protocol1_21_7: 0x01, protocol1_21_9: 0x01, protocol1_21_11: 0x01, protocol26_1: 0x01, protocol26_2: 0x01, protocol26_3: 0x01},
	},

	{
		...
		ids:     packetIds{protocol1_14: 0x00, protocol1_14_1: 0x00, protocol1_14_2: 0x00, protocol1_14_3: 0x00, protocol1_14_4: 0x00, protocol1_15: 0x00, protocol1_15_1: 0x00, protocol1_15_2: 0x00, protocol1_16: 0x00, protocol1_16_1: 0x00, protocol1_16_2: 0x00, protocol1_16_3: 0x00, protocol1_16_4: 0x00, protocol1_17: 0x00, protocol1_17_1: 0x00, protocol1_18: 0x00, protocol1_18_2: 0x00, protocol1_19: 0x00, protocol1_19_1: 0x00, protocol1_19_3: 0x00, protocol1_19_4: 0x00, protocol1_20: 0x00, protocol1_20_2: 0x00, protocol1_20_3: 0x00, protocol1_20_5: 0x00, protocol1_21: 0x00, protocol1_21_2: 0x00, protocol1_21_4: 0x00, protocol1_21_5: 0x00, protocol1_21_6: 0x00, protocol1_21_7: 0x00, protocol1_21_9: 0x00, protocol1_21_11: 0x00, protocol26_1: 0x00, protocol26_2: 0x00, protocol26_3: 0x00},
	},
	{
		phase:   types.PhaseLogin,
		...
		ids:     packetIds{protocol1_14: 0x01, protocol1_14_1: 0x01, protocol1_14_2: 0x01, protocol1_14_3: 0x01, protocol1_14_4: 0x01, protocol1_15: 0x01, protocol1_15_1: 0x01, protocol1_15_2: 0x01, protocol1_16: 0x01, protocol1_16_1: 0x01, protocol1_16_2: 0x01, protocol1_16_3: 0x01, protocol1_16_4: 0x01, protocol1_17: 0x01, protocol1_17_1: 0x01, protocol1_18: 0x01, protocol1_18_2: 0x01, protocol1_19: 0x01, protocol1_19_1: 0x01, protocol1_19_3: 0x01, protocol1_19_4: 0x01, protocol1_20: 0x01, protocol1_20_2: 0x01, protocol1_20_3: 0x01, protocol1_20_5: 0x01, protocol1_21: 0x01, protocol1_21_2: 0x01, protocol1_21_4: 0x01, protocol1_21_5: 0x01, protocol1_21_6: 0x01, protocol1_21_7: 0x01, protocol1_21_9: 0x01, protocol1_21_11: 0x01, protocol26_1: 0x01, protocol26_2: 0x01, protocol26_3: 0x01},
	},
	{
		phase:   types.PhaseLogin,
	...
	},
	{
		...
		ids:     packetIds{protocol1_20_2: 0x03, protocol1_20_3: 0x03, protocol1_20_5: 0x03, protocol1_21: 0x03, protocol1_21_2: 0x03, protocol1_21_4: 0x03, protocol1_21_5: 0x03, protocol1_21_6: 0x03, protocol1_21_7: 0x03, protocol1_21_9: 0x03, protocol1_21_11: 0x03, protocol26_1: 0x03, protocol26_2: 0x03, protocol26_3: 0x03},
	},

	{
		...
		ids:     packetIds{protocol1_20_2: 0x02, protocol1_20_3: 0x02, protocol1_20_5: 0x03, protocol1_21: 0x03, protocol1_21_2: 0x03, protocol1_21_4: 0x03, protocol1_21_5: 0x03, protocol1_21_6: 0x03, protocol1_21_7: 0x03, protocol1_21_9: 0x03, protocol1_21_11: 0x03, protocol26_1: 0x03, protocol26_2: 0x03, protocol26_3: 0x03},
	},
	...
	// gives it.
	{
		...
		ids:     packetIds{protocol1_20_2: 0x03, protocol1_20_3: 0x03, protocol1_20_5: 0x04, protocol1_21: 0x04, protocol1_21_2: 0x04, protocol1_21_4: 0x04, protocol1_21_5: 0x04, protocol1_21_6: 0x04, protocol1_21_7: 0x04, protocol1_21_9: 0x04, protocol1_21_11: 0x04, protocol26_1: 0x04, protocol26_2: 0x04, protocol26_3: 0x04},
	},
	{
	...
	},
	{
		...
		ids:     packetIds{protocol1_21_2: 0x0B, protocol1_21_4: 0x0B, protocol1_21_5: 0x0B, protocol1_21_6: 0x0C, protocol1_21_7: 0x0C, protocol1_21_9: 0x0C, protocol1_21_11: 0x0C, protocol26_1: 0x0D, protocol26_2: 0x0D, protocol26_3: 0x0D},
	},
	...
	},
	{
		...
		ids:     packetIds{protocol1_21_4: 0x2A, protocol1_21_5: 0x2A, protocol1_21_6: 0x2B, protocol1_21_7: 0x2B, protocol1_21_9: 0x2B, protocol1_21_11: 0x2B, protocol26_1: 0x2C, protocol26_2: 0x2C, protocol26_3: 0x2C},
	},
}

// clientboundPackets is every packet the server writes.
//
// 26.2 numbers every play packet this server sends from the game event on
// one lower than 26.3 does, and the rotate head, the chunk cache centre and
// the entity metadata two lower: 26.3 added the transient block in front
// of the game event and the post effects further along, and put the swing
// animation at 0x7B behind everything else, which 26.2 has no packet for
// and reads as the animate packet at 0x02 -- so the ids below 26.3 in that
// row are the animate's, and the 26.3 step rewrites the body into its
// shape. In the configuration phase 26.3 put the post effects in front of
// the tags, so 26.2 reads those one lower; the login and status phases are
// numbered alike. 1.21.4 numbers every play packet after the add entity one higher than
...
// same list in the same order. 1.17.1 numbers every phase as 1.18 does but
// for the end of the play phase: 1.18 added the simulation distance at
// 0x57, so the teleport and the tags are one lower on 1.17.1, at 0x61 and
// 0x66, and the chunk keeps 0x22 under its older name, with the light
// update beside it at 0x25. 1.17 numbers every phase as 1.17.1 does, the two
// jars' registrations being the same list in the same order, the light
// update included. 1.16.4 numbers the play phase its own way below that:
// 1.17 added the vibration signal at 0x05, retired the container
// acknowledgement for the ping further along, split the world border, the
// combat and the title packets into a packet for each thing they said, and
// added the clear titles and the action bar. So the add player sits alike
// and the animate one lower, at 0x05; the keep alive, the chunk, the light
// update and the login two lower; the player list -- at 0x32 -- the player
// position, the remove entities and the rotate head four lower; the chunk
// cache centre, the spawn position and the entity metadata nine lower; and
// the teleport and the tags, at 0x5B, eleven lower. The login phase is
// numbered alike. 1.16.3 and 1.16.2 number every phase as 1.16.4 does.
// 1.16.1 sits one higher from 0x0F to 0x3B: it still has the chunk blocks
// update at 0x0F, which 1.16.2 retired for the section blocks update at
...
// them one higher again. 1.15.1 and 1.15 number every phase as 1.15.2 does.
// 1.14.4 sits one lower than 1.15 from 0x09 on: its block break
// acknowledgement is the last packet of the phase, at 0x5C, where 1.15 moved
// it up to 0x08 among the other block packets, in front of everything this
// server sends but the add player and the animate. 1.14.3 numbers what this
// server sends as 1.14.4 does: that acknowledgement is what 1.14.4 added,
// and behind everything else, so 1.14.3's phase ends one packet sooner.
// 1.14.2 numbers every phase as 1.14.3 does: the two register the same
// packets in the same order. 1.14.1 numbers every phase as 1.14.2 does: the
// two jars' connection protocol is one class byte for byte. 1.14 numbers
// every phase as 1.14.1 does: the two register the same packets in the same
// order.
// The login phase is numbered alike.
var clientboundPackets = []clientboundPacket{
	...
	},
	{
		...
		ids:    packetIds{protocol1_20_2: 0x05, protocol1_20_3: 0x05, protocol1_20_5: 0x07, protocol1_21: 0x07, protocol1_21_2: 0x07, protocol1_21_4: 0x07, protocol1_21_5: 0x07, protocol1_21_6: 0x07, protocol1_21_7: 0x07, protocol1_21_9: 0x07, protocol1_21_11: 0x07, protocol26_1: 0x07, protocol26_2: 0x07, protocol26_3: 0x07},
	},
	...
	// does.
	{
		...
		ids:    packetIds{protocol1_14: 0x5B, protocol1_14_1: 0x5B, protocol1_14_2: 0x5B, protocol1_14_3: 0x5B, protocol1_14_4: 0x5B, protocol1_15: 0x5C, protocol1_15_1: 0x5C, protocol1_15_2: 0x5C, protocol1_16: 0x5B, protocol1_16_1: 0x5B, protocol1_16_2: 0x5B, protocol1_16_3: 0x5B, protocol1_16_4: 0x5B, protocol1_17: 0x66, protocol1_17_1: 0x66, protocol1_18: 0x67, protocol1_18_2: 0x67, protocol1_19: 0x68, protocol1_19_1: 0x6B, protocol1_19_3: 0x6A, protocol1_19_4: 0x6E, protocol1_20: 0x6E},
	},
	{
		phase:  types.PhaseConfiguration,
		packet: reflect.TypeOf(clientboundConfiguration.UpdateTagsClientboundPacket{}),
		ids:    packetIds{protocol1_20_2: 0x08, protocol1_20_3: 0x09, protocol1_20_5: 0x0D, protocol1_21: 0x0D, protocol1_21_2: 0x0D, protocol1_21_4: 0x0D, protocol1_21_5: 0x0D, protocol1_21_6: 0x0D, protocol1_21_7: 0x0D, protocol1_21_9: 0x0D, protocol1_21_11: 0x0D, protocol26_1: 0x0D, protocol26_2: 0x0D, protocol26_3: 0x0E},
	},
	...
	// one is wrong for another: sections name block states by each version's
	// own numbering, and package world resolves that before the packet exists
	// by building a packet per version. Outside that range the packet's own
	// fields are carried by the steps that changed them -- the light masks at
	// 26.3, the heightmaps at 1.21.5 and 1.20.2, the trust edges flag at 1.20
	// -- and at 1.18 the packet
	// whole, since 1.17.1 reads it under this id as the chunk alone, its
	// light in the packet below.
	{
		phase:  types.PhasePlay,
		packet: reflect.TypeOf(clientboundPlay.LevelChunkWithLightClientboundPacket{}),
		ids:    packetIds{protocol1_14: 0x21, protocol1_14_1: 0x21, protocol1_14_2: 0x21, protocol1_14_3: 0x21, protocol1_14_4: 0x21, protocol1_15: 0x22, protocol1_15_1: 0x22, protocol1_15_2: 0x22, protocol1_16: 0x21, protocol1_16_1: 0x21, protocol1_16_2: 0x20, protocol1_16_3: 0x20, protocol1_16_4: 0x20, protocol1_17: 0x22, protocol1_17_1: 0x22, protocol1_18: 0x22, protocol1_18_2: 0x22, protocol1_19: 0x1F, protocol1_19_1: 0x21, protocol1_19_3: 0x20, protocol1_19_4: 0x24, protocol1_20: 0x24, protocol1_20_2: 0x25, protocol1_20_3: 0x25, protocol1_20_5: 0x27, protocol1_21: 0x27, protocol1_21_2: 0x28, protocol1_21_4: 0x28, protocol1_21_5: 0x27, protocol1_21_6: 0x27, protocol1_21_7: 0x27, protocol1_21_9: 0x2C, protocol1_21_11: 0x2C, protocol26_1: 0x2D, protocol26_2: 0x2D, protocol26_3: 0x2E},
	},
	...
	// version from it on has no id for this one. Package world builds one
	// beside each chunk for a version that reads it, and the 1.17 step
	// rewrites it for 1.16.4, which reads its masks as plain numbers.
	{
		phase:  types.PhasePlay,
...
type RegistryCodecSource interface {
	...
	// as a name: see the 1.19 step's login transformer. For a version below
	// 1.16.2 it is the name that login holds instead, as the string it is
	// written as: see the 1.16.2 step's.
...
//
// The 26.3 step carries eight, six downwards and two upwards, because 26.3 is
// where the arm swing was reworked on both sides and where a bit set changed
// shape on the wire. Downwards: the chunk packet and the light packet 1.17.1
// reads, whose four light masks are bit sets, sent as counted bytes from 26.3
// on and read as counted longs before it; the play login,
// whose spawn info spells the previous game mode as an optional var int
// where 26.2 reads a byte that is -1 for none; the add entity packet, for
// the registry renumbering again, since 26.3's cushion and poplar boats
// sort before the player; the entity position sync, whose point and delta
// movement 26.3 turned into a path, so the path type comes off and the
// delta goes back in as zero; and the swing animation, a packet 26.3 added
// that 26.2 reads as the animate packet, the entity and a byte naming the
// arm. Upwards: the punch, which 26.2 sends as the swing with a hand 26.3
// does without, and the accept teleportation, onto which 26.3 put the
// position and the rotation, which go in as zero since nothing here reads
// them. Every other packet this server speaks is wire-identical in 776 and
// 777, checked against the two clients' own classes: the chunk packet but
// for its masks, the registry and tag payloads and the entity metadata
// included, and the dimension type and biome codecs ask for the same fields. The rest of the
// bump is data: three synchronized registries more, 26.3's own content in
// the ones it shares, and the block state table from its jar.
//
...
// one block tag fewer.
//
// The 1.18 step carries two, downwards: the play login, from whose end
// 1.18's simulation distance comes off and whose registries and spelled-out
// dimension type are 1.17.1's own -- the same two registries, the biome
// carrying the depth and the scale 1.18 took off its codec -- so this
// rewrite is built around what registryCodecs hands out for 1.17.1, the
// registries and the dimension type both; and the chunk packet, which 1.18
// reworked whole: the light folded in, a biome container in every section,
// a palette of one for a section of one state, and every section sent,
// where 1.17.1 reads the light in a packet of its own, the biomes as one
// array, the smallest palette at four bits, and only the sections that hold
// a block behind a mask. Package world sends the light packet 1.17.1 reads
// ahead of each chunk, and the rewrite drops the light the chunk carries.
// 1.18 renumbered the end of the clientbound play phase, which the id
// tables say, and everything else is wire-identical in 756 and 757, checked
// the same way; the block state table is byte-identical too, and the rest
// of the bump is data: the same five tag sets with 1.17.1's own names.
//
// The 1.17.1 step carries one, downwards: the remove entities packet, which
// 1.17 alone reads as a single id rather than a list. The two clients'
// classes were compared whole: the protocol registration is the same list
// in the same order, so 755 numbers every packet as 756 does, and the other
// four packets 1.17.1 laid out anew -- the container content and slot, the
// container click and the book edit -- are none this server speaks. There
// is no data to the bump: the registries' codecs, the tags' names and the
// blocks are untouched, so 755 shares 756's of each.
//
// The 1.17 step carries six, all downwards, because 1.17 is where the world
// grew downwards and 1.16.4 holds sixteen sections from zero up: the play
// login, laid out alike around 1.16.4's own registries and a dimension type
// with no bounds to it; the chunk packet and the light packet ahead of it,
// whose sections 1.16.4 names by plain numbers rather than bit sets, cut
// down to the ones it holds, with the heightmaps brought down to match; the
// player position, without the dismount flag 1.17 put on its end; the spawn
// position this server's game event has been since the 1.20.3 step, without
// the angle 1.17 put on its end; and the remove entities packet, whose
// count the 1.17.1 step took off for 1.17 alone and which goes back on. The
// tags differ as well -- 1.16.4 reads four runs of them with no registry
// named -- and package gamedata encodes them that way, as it encodes them
// per version to begin with. Everything this server reads is laid out
// alike. The data is 1.16.4's own: its tags' names, and a block state table
// from before the caves and cliffs blocks.
//
// The 1.16.4 step carries none. 754 is the social interactions screen, which
// a client keeps to itself: 1.16.3 numbers every packet as 1.16.4 does and
// lays every one this server speaks out alike, the two jars' classes
// differing in nothing but how the login's public key is held before it is
// written as the same bytes. There is no data to the bump either: the
// codecs, the tags and the blocks report are the same, so 753 shares 754's
// of each.
//
// The 1.16.3 step carries none either, and has less to say for itself: 753
// is a fix to how mobs find their way. Of the 5,426 classes in the two jars,
// six differ -- the one that names the version, and the mob and its
// pathfinding -- and every other is 1.16.2's byte for byte, the connection
// protocol and every packet among them. The data is the same files, so 751
// shares 754's of everything as well.
func registerTransformers(packetRegistry *Registry, registryCodecs RegistryCodecSource) {
	...
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_26_3,
		reflect.TypeOf(clientboundPlay.LoginClientboundPacket{}),
		transformers.DowngradePlayLoginTo26_2,
	)

	// 26.3's registry additions renumbered the player.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_26_3,
		reflect.TypeOf(clientboundPlay.AddEntityClientboundPacket{}),
		transformers.DowngradeAddEntityTo26_2,
	)

	// 26.3 turned the entity position sync's point and delta movement into a
	// path, and gave the arm swing a packet of its own where 26.2 reads the
	// animate packet.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_26_3,
		reflect.TypeOf(clientboundPlay.EntityPositionSyncClientboundPacket{}),
		transformers.DowngradeEntityPositionSyncTo26_2,
	)

	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_26_3,
		reflect.TypeOf(clientboundPlay.SwingAnimationClientboundPacket{}),
		transformers.DowngradeSwingAnimationTo26_2,
	)

	// 26.3 sends a bit set as bytes where 26.2 reads longs, and the four
	// light masks are bit sets: in the chunk packet, and in the light packet
	// 1.17.1 alone reads, which is built at 26.3 like everything else.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_26_3,
		reflect.TypeOf(clientboundPlay.LevelChunkWithLightClientboundPacket{}),
		transformers.DowngradeLevelChunkWithLightTo26_2,
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		transformers.DowngradeLightUpdateTo26_2,
	)

	// The two packets a 26.2 client sends that 26.3 lays out differently: the
	// swing, which names a hand 26.3's punch does without, and the accept
	// teleportation, onto which 26.3 put the position and the rotation.
	packetRegistry.RegisterUpgrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_26_2,
		reflect.TypeOf(serverboundPlay.PunchServerboundPacket{}),
		transformers.UpgradePunchFrom26_2,
	)

	packetRegistry.RegisterUpgrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_26_2,
		reflect.TypeOf(serverboundPlay.AcceptTeleportationServerboundPacket{}),
		transformers.UpgradeAcceptTeleportationFrom26_2,
	)
	...
	var registryCodec1_20, registryCodec1_19_4, registryCodec1_19_3, registryCodec1_19_1, registryCodec1_19, registryCodec1_18_2, dimensionType1_18_2, registryCodec1_18, dimensionType1_18, registryCodec1_17_1, dimensionType1_17_1, registryCodec1_16_4, dimensionType1_16_4, dimensionTypes1_16_1, dimensionTypeName1_16_1 []byte
	if registryCodecs != nil {
		...
		registryCodec1_17_1 = registryCodecs.RegistryCodecFor(types.ProtocolVersions.MINECRAFT_1_17_1)
		dimensionType1_17_1 = registryCodecs.DimensionTypeFor(types.ProtocolVersions.MINECRAFT_1_17_1)
		registryCodec1_16_4 = registryCodecs.RegistryCodecFor(types.ProtocolVersions.MINECRAFT_1_16_4)
		dimensionType1_16_4 = registryCodecs.DimensionTypeFor(types.ProtocolVersions.MINECRAFT_1_16_4)
		dimensionTypes1_16_1 = registryCodecs.RegistryCodecFor(types.ProtocolVersions.MINECRAFT_1_16_1)
		dimensionTypeName1_16_1 = registryCodecs.DimensionTypeFor(types.ProtocolVersions.MINECRAFT_1_16_1)
	}
	...
	// 1.18 is where the world grew: the simulation distance joined the play
	// login, whose registries and dimension type are 1.17.1's own below it,
	// and the chunk packet took the light in, the biomes into its sections
	// and a palette of one, where 1.17.1 reads the light on its own, the
	// biomes as one array, the sections behind a mask and no palette under
	// four bits.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_1_18,
		reflect.TypeOf(clientboundPlay.LoginClientboundPacket{}),
		transformers.DowngradePlayLoginTo1_17_1(registryCodec1_17_1, dimensionType1_17_1),
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_18,
		reflect.TypeOf(clientboundPlay.LevelChunkWithLightClientboundPacket{}),
		transformers.DowngradeLevelChunkWithLightTo1_17_1,
	)

	// 1.17.1 put the remove entities packet back to a list of ids, where
	// 1.17 alone reads one id to a packet.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_1_17_1,
		reflect.TypeOf(clientboundPlay.RemoveEntitiesClientboundPacket{}),
		transformers.DowngradeRemoveEntitiesTo1_17,
	)

	// 1.17 is where the world grew downwards: the dimension type took on its
	// bounds, and the chunk and its light came to name their sections by bit
	// sets, where 1.16.4 holds sixteen sections from zero up behind masks
	// that are plain numbers. It is also where the player position took on
	// its dismount flag and the spawn position its angle, and the one
	// version whose entity removal 1.16.4 does not read, the count going
	// back in front.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_1_17,
		reflect.TypeOf(clientboundPlay.LoginClientboundPacket{}),
		transformers.DowngradePlayLoginTo1_16_4(registryCodec1_16_4, dimensionType1_16_4),
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_17,
		reflect.TypeOf(clientboundPlay.LevelChunkWithLightClientboundPacket{}),
		transformers.DowngradeLevelChunkTo1_16_4,
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_17,
		reflect.TypeOf(clientboundPlay.LightUpdateClientboundPacket{}),
		transformers.DowngradeLightUpdateTo1_16_4,
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_17,
		reflect.TypeOf(clientboundPlay.PlayerPositionClientboundPacket{}),
		transformers.DowngradePlayerPositionTo1_16_4,
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_17,
		reflect.TypeOf(clientboundPlay.GameEventClientboundPacket{}),
		transformers.DowngradeSetDefaultSpawnPositionTo1_16_4,
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_17,
		reflect.TypeOf(clientboundPlay.RemoveEntitiesClientboundPacket{}),
		transformers.DowngradeRemoveEntitiesTo1_16_4,
	)

	// 1.16.2 is where the biomes became data and joined the dimension types
	// in the play login, which 1.16.1 reads the dimension types out of alone
	// and is put into one of by name. It is also where the chunk packet lost
	// its second flag and its biomes took on a count.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_1_16_2,
		reflect.TypeOf(clientboundPlay.LoginClientboundPacket{}),
		transformers.DowngradePlayLoginTo1_16_1(dimensionTypes1_16_1, dimensionTypeName1_16_1),
	)
	...
	// 1.15 is where the biomes of a chunk took on a height and moved out of
	// the end of its sections into the packet itself, where the play login
	// took on the seed and the flag for the death screen, and where the add
	// player packet -- which the add entity packet is by now -- lost the
	// entity metadata 1.14.4 reads off its end.
	packetRegistry.RegisterDowngrade(
		types.PhasePlay,
		types.ProtocolVersions.MINECRAFT_1_15,
		reflect.TypeOf(clientboundPlay.LoginClientboundPacket{}),
		transformers.DowngradePlayLoginTo1_14_4,
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_15,
		reflect.TypeOf(clientboundPlay.LevelChunkWithLightClientboundPacket{}),
		transformers.DowngradeLevelChunkTo1_14_4,
	)
	...
	packetRegistry.RegisterDowngrade(
		...
		types.ProtocolVersions.MINECRAFT_1_15,
		reflect.TypeOf(clientboundPlay.AddEntityClientboundPacket{}),
		transformers.DowngradeAddPlayerTo1_14_4,
	)
