...
func (r *PacketRegistry) RegisterServerbound(phase types.Phase, packet reflect.Type, decoder PacketDecoder, handler types.PacketHandler) {
...
func (r *PacketRegistry) RegisterServerboundId(phase types.Phase, protocolVersion types.ProtocolVersion, packet reflect.Type, packetId types.PacketId) {
...
func (r *PacketRegistry) RegisterClientboundId(phase types.Phase, protocolVersion types.ProtocolVersion, packet reflect.Type, packetId types.PacketId) {
...
func (r *PacketRegistry) RegisterUpgrade(phase types.Phase, protocolVersion types.ProtocolVersion, packet reflect.Type, transformer Transformer) {
...
func (r *PacketRegistry) RegisterDowngrade(phase types.Phase, protocolVersion types.ProtocolVersion, packet reflect.Type, transformer Transformer) {
...
// on.
func (r *PacketRegistry) GetServerboundType(phase types.Phase, protocolVersion types.ProtocolVersion, packetId types.PacketId) (reflect.Type, bool) {
...
func (r *PacketRegistry) GetServerbound(phase types.Phase, packet reflect.Type) (ServerboundEntry, bool) {
...
// up from.
func (r *PacketRegistry) UpgradeBody(phase types.Phase, packet reflect.Type, from types.ProtocolVersion, body []byte) ([]byte, error) {
...
func (r *PacketRegistry) DowngradeBody(phase types.Phase, packet reflect.Type, to types.ProtocolVersion, body []byte) ([]byte, error) {
