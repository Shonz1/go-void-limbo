...
func TestAddEntityClientboundPacketEncode(t *testing.T) {
	...
	want = append(want,
		0x9F, 0x01, // the player's entity type, 159 as a var int
...
func TestEntityPositionSyncClientboundPacketEncode(t *testing.T) {
	...
	want := []byte{
		0x02,
		0x00,                                           // a straight line to the point below
		0x3F, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // x, 0.5
		0x40, 0x50, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // y, 64
		0xBF, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // z, -0.5
...
func TestSwingAnimationClientboundPacketEncode(t *testing.T) {
	p := &SwingAnimationClientboundPacket{EntityId: 2, OffHand: true, Animation: SwingAnimationStab, Duration: DefaultSwingDuration}
