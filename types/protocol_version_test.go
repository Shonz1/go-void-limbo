...
func TestGetProtocolVersionById(t *testing.T) {
	cases := []struct {
		...
		{"minecraft_1_14", ProtocolVersions.MINECRAFT_1_14.ID, ProtocolVersions.MINECRAFT_1_14},
		{"minecraft_1_14_1", ProtocolVersions.MINECRAFT_1_14_1.ID, ProtocolVersions.MINECRAFT_1_14_1},
		{"minecraft_1_14_2", ProtocolVersions.MINECRAFT_1_14_2.ID, ProtocolVersions.MINECRAFT_1_14_2},
		{"minecraft_1_14_3", ProtocolVersions.MINECRAFT_1_14_3.ID, ProtocolVersions.MINECRAFT_1_14_3},
		{"minecraft_1_14_4", ProtocolVersions.MINECRAFT_1_14_4.ID, ProtocolVersions.MINECRAFT_1_14_4},
		{"minecraft_1_15", ProtocolVersions.MINECRAFT_1_15.ID, ProtocolVersions.MINECRAFT_1_15},
		{"minecraft_1_15_1", ProtocolVersions.MINECRAFT_1_15_1.ID, ProtocolVersions.MINECRAFT_1_15_1},
		{"minecraft_1_15_2", ProtocolVersions.MINECRAFT_1_15_2.ID, ProtocolVersions.MINECRAFT_1_15_2},
		{"minecraft_1_16", ProtocolVersions.MINECRAFT_1_16.ID, ProtocolVersions.MINECRAFT_1_16},
		{"minecraft_1_16_1", ProtocolVersions.MINECRAFT_1_16_1.ID, ProtocolVersions.MINECRAFT_1_16_1},
		...
		{"minecraft_1_17_1", ProtocolVersions.MINECRAFT_1_17_1.ID, ProtocolVersions.MINECRAFT_1_17_1},
		{"minecraft_1_18", ProtocolVersions.MINECRAFT_1_18.ID, ProtocolVersions.MINECRAFT_1_18},
...
func TestPreviousProtocolVersion(t *testing.T) {
	...
	previous, ok = PreviousProtocolVersion(ProtocolVersions.MINECRAFT_1_18_2)
	if !ok {
		t.Fatal("expected a version below 1.18.2")
	}

	if previous.ID != ProtocolVersions.MINECRAFT_1_18.ID {
		t.Errorf("expected 1.18 below 1.18.2, got %d", previous.ID)
	}

	previous, ok = PreviousProtocolVersion(ProtocolVersions.MINECRAFT_1_18)
	if !ok {
		t.Fatal("expected a version below 1.18")
	}

	if previous.ID != ProtocolVersions.MINECRAFT_1_17_1.ID {
		t.Errorf("expected 1.17.1 below 1.18, got %d", previous.ID)
	}
...
// passes through the phase, and the twenty-two versions below it go from their
// login straight into play.
func TestHasConfigurationPhase(t *testing.T) {
	for _, version := range SupportedProtocolVersions[:22] {
	...
	if ProtocolVersions.MINECRAFT_1_18.HasConfigurationPhase() {
		t.Error("1.18 has a configuration phase, want the login to lead straight into play")
	}

	if ProtocolVersions.MINECRAFT_1_17_1.HasConfigurationPhase() {
...
// encrypts, as do 1.18.2, 1.18 and 1.17.1 below the two, from before there
// was a key.
func TestMaySignEncryptionChallenge(t *testing.T) {
	if ProtocolVersions.MINECRAFT_1_17_1.MaySignEncryptionChallenge() {
		t.Error("1.17.1 may sign the encryption challenge, want a client from before the profile key to encrypt it")
	}

	if ProtocolVersions.MINECRAFT_1_18.MaySignEncryptionChallenge() {
		t.Error("1.18 may sign the encryption challenge, want a client from before the profile key to encrypt it")
	}
	...
	for _, version := range SupportedProtocolVersions[19:] {
