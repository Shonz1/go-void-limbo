...
func TestStatusVersionIsTheClientsWhenThisServerSpeaksIt(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "1.14", version: types.ProtocolVersions.MINECRAFT_1_14, want: types.ServerVersion{Name: "1.14", Protocol: types.ProtocolVersions.MINECRAFT_1_14.ID}},
		{name: "1.14.1", version: types.ProtocolVersions.MINECRAFT_1_14_1, want: types.ServerVersion{Name: "1.14.1", Protocol: types.ProtocolVersions.MINECRAFT_1_14_1.ID}},
		{name: "1.14.2", version: types.ProtocolVersions.MINECRAFT_1_14_2, want: types.ServerVersion{Name: "1.14.2", Protocol: types.ProtocolVersions.MINECRAFT_1_14_2.ID}},
		{name: "1.14.3", version: types.ProtocolVersions.MINECRAFT_1_14_3, want: types.ServerVersion{Name: "1.14.3", Protocol: types.ProtocolVersions.MINECRAFT_1_14_3.ID}},
		{name: "1.14.4", version: types.ProtocolVersions.MINECRAFT_1_14_4, want: types.ServerVersion{Name: "1.14.4", Protocol: types.ProtocolVersions.MINECRAFT_1_14_4.ID}},
		...
		{name: "1.16.1", version: types.ProtocolVersions.MINECRAFT_1_16_1, want: types.ServerVersion{Name: "1.16.1", Protocol: types.ProtocolVersions.MINECRAFT_1_16_1.ID}},
		{name: "1.16.2", version: types.ProtocolVersions.MINECRAFT_1_16_2, want: types.ServerVersion{Name: "1.16.2", Protocol: types.ProtocolVersions.MINECRAFT_1_16_2.ID}},
		{name: "1.16.3", version: types.ProtocolVersions.MINECRAFT_1_16_3, want: types.ServerVersion{Name: "1.16.3", Protocol: types.ProtocolVersions.MINECRAFT_1_16_3.ID}},
		{name: "1.16.4", version: types.ProtocolVersions.MINECRAFT_1_16_4, want: types.ServerVersion{Name: "1.16.4", Protocol: types.ProtocolVersions.MINECRAFT_1_16_4.ID}},
		{name: "1.17", version: types.ProtocolVersions.MINECRAFT_1_17, want: types.ServerVersion{Name: "1.17", Protocol: types.ProtocolVersions.MINECRAFT_1_17.ID}},
		{name: "1.17.1", version: types.ProtocolVersions.MINECRAFT_1_17_1, want: types.ServerVersion{Name: "1.17.1", Protocol: types.ProtocolVersions.MINECRAFT_1_17_1.ID}},
		{name: "1.18", version: types.ProtocolVersions.MINECRAFT_1_18, want: types.ServerVersion{Name: "1.18", Protocol: types.ProtocolVersions.MINECRAFT_1_18.ID}},
		{name: "1.18.2", version: types.ProtocolVersions.MINECRAFT_1_18_2, want: types.ServerVersion{Name: "1.18.2", Protocol: types.ProtocolVersions.MINECRAFT_1_18_2.ID}},
		{name: "1.19", version: types.ProtocolVersions.MINECRAFT_1_19, want: types.ServerVersion{Name: "1.19", Protocol: types.ProtocolVersions.MINECRAFT_1_19.ID}},
		{name: "1.19.1", version: types.ProtocolVersions.MINECRAFT_1_19_1, want: types.ServerVersion{Name: "1.19.1", Protocol: types.ProtocolVersions.MINECRAFT_1_19_1.ID}},
		{name: "1.19.3", version: types.ProtocolVersions.MINECRAFT_1_19_3, want: types.ServerVersion{Name: "1.19.3", Protocol: types.ProtocolVersions.MINECRAFT_1_19_3.ID}},
		{name: "1.19.4", version: types.ProtocolVersions.MINECRAFT_1_19_4, want: types.ServerVersion{Name: "1.19.4", Protocol: types.ProtocolVersions.MINECRAFT_1_19_4.ID}},
